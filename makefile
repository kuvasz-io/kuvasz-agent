...
package: kuvasz-agent kuvasz-agent.ini 
	...
	fpm -s dir -t rpm -n kuvasz-agent -v 3 --iteration 1 --config-files /etc/kuvasz/kuvasz-agent.ini --config-files /usr/lib/systemd/system/kuvasz-agent.service --license Proprietary --vendor Kuvasz.io -m help@kuvasz.io --description "Kuvasz agent" --url "http://kuvasz.io" --after-install packaging/postinst.rpm -C packaging/rpm .
	...
	fpm -s dir -t deb -n kuvasz-agent -v 3 --epoch 1 --config-files /etc/kuvasz/kuvasz-agent.ini --license Proprietary --vendor Kuvasz.io -m help@kuvasz.io --description "Kuvasz agent" --url "http://kuvasz.io" --after-install packaging/postinst.deb -C packaging/deb .
